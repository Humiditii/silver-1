        ...
        <Aux>
            <div align='center' style={{marginRight: '10px', marginLeft: '10px'}} >
                ...
                <div style={{fontSize: '20px', minHeight:'25vh', marginBottom: '60px'}} >
                   ...
                   <p style={{marginRight: '30px', marginLeft: '30px'}} align='center'> Humans are unable to outperform computers in tasks involving huge automation or calculations, Silver-1 is a solution to relive those stresses imposed on humans.  <i><b><i className="material-icons small">computer</i></b></i>.Try it out and relive unnecessary stress <i className="material-icons small">sentiment_very_satisfied</i> .</p> <p> Read through the Features, and get started  <i className="material-icons small">add</i></p> <p style={{font: '10px'}} > Version 0.1.0  <i className="material-icons small">thumb_up</i></p>
                </div>
